...
**genefer** [version 22](https://github.com/galloty/genefer22) is a new C++ application, created in 2022. The previous versions inherited the originally code written in C and a new design was necessary to achieve new levels of complexity.  
...
**genefer** [version 26](https://github.com/galloty/genefer26), created in 2026, checks a list of 8, 16 or 32 GFN. It is recommended for the search in the range 15&nbsp;&le;&nbsp;*n*&nbsp;&le;&nbsp;17.  
